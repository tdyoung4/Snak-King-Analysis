...
if page == "Home":
    # Title
    st.markdown('<div class="main-header"><h1 style="color: white; margin: 0;">Snak King Product Opportunity Analyzer</h1><p style="color: white; margin: 10px 0 0 0;">Data-Driven Product Launch Strategy</p></div>', unsafe_allow_html=True)
